...
The write-off for ("blackhole") business capital costs is outlined at ¶16-156 and the deduction for mains electricity supply is at ¶16-820.

A separate regime (ITAA97 Div 43) applies to capital works expenditure on buildings and structural improvements (¶20-470).

Small business entities can choose simplified depreciation arrangements (¶7-250).