...
The attribution debit cannot exceed the amount standing to the credit of the account at that time (the "attribution surplus"). This means that the attribution surplus is the maximum amount of previously attributed income against which the resident taxpayer can offset distributed CFC income for exemption purposes.
