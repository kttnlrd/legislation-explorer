...
- a return for a deceased taxpayer is lodged for the period from the first day of the income year to
...
- a dissolved company lodges a return from the first day of the income year to the date of

  dissolution

- where there is any variation in the membership of a partnership, a return may need to be lodged

  for the partnership as originally constituted from the first day of the income year to the date of the
...
- where a trust is created or terminated, a return must be lodged for the period from its creation to
  ...
  the end of the income year, or from the first day of the income year to the trust's dissolution.
