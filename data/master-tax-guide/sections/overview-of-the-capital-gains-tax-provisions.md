...
The special CGT rules under Pt 3-3 and the value shifting rules are dealt with in ¶12-000ff. The CGT small business concessions are covered from ¶7-110. Note that all section references in this chapter are to ITAA97 unless otherwise indicated.
...
- ascertaining which, if any, CGT event has occurred (as this affects the calculation and timing of any assessable gain)

- the loss of an asset's pre-CGT status where the underlying beneficial interests change
...
Great care should be taken to ensure that an asset-rich individual preparing a will is aware of the likely CGT consequences of creating interests such as life estates where the final distribution of the assets is effectively postponed (¶12-580). In the Commissioner's view, the transfer of an asset from the trustee of a testamentary trust, established by will after administration, to a remainderman following the death of a life tenant is not eligible for roll-over. Nor is the passing of an asset from a trustee of a testamentary trust to a beneficiary, where the asset is a substitute for an asset held by the deceased at the date of death.
