...
For gaseous fuels (¶40-100), the road user charge effectively reduces the credit rate to zero.
...
- any specific alterations or modifications which make the vehicle's use different from the use for
