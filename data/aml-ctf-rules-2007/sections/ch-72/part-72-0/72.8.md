...
Schedule Reportable details for International Funds Transfer Instructions – account-based money transfers Instructions transmitted into Australia 1. For the purposes of paragraphs 72.4(1) and 72.7(1), a report about an international funds transfer instruction (the instruction) must contain:
...
**(i)** the ultimate transferee entity's email address, if known; (14)
...
Instructions transmitted out of Australia 2. For the purposes of paragraphs 72.4(2) and 72.7(2) of these AML/CTF Rules, a report about an international funds transfer instruction (the instruction) must contain:
...
**(g)** the ultimate transferee entity's email address, if known; (13)
