...
if the person has an obligation under Part 2M.3 of the Corporations Act 2001:
the financial report (or foreign equivalent) for the most recent financial year before the census day;
if the person does not have an obligation under Part 2M.3 of the Corporations Act 2001:
those consolidated documents which are used to calculate the EBITDA for the most recent financial year before the census day;
