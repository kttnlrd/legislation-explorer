...
> <a id="s960-85-1-b"></a>
> **(b)** the amount is attributable to an event that happened, or a state of affairs that came into existence, at a time (the event time) before the current choice took effect; the table has effect: Special rule about translation
