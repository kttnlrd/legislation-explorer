...
<a id="s960-190-1"></a>
**(1)** Use the following table to work out the direct participation interest that one entity holds in another entity. Direct participation interest If the other entity     the direct participation interest that the first entity

| entity: 1 | A company (within | the direct control interest (within the meaning of |
| --- | --- | --- |
