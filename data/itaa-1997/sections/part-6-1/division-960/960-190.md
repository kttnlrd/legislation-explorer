...
subdivision: "960-GP"
subdivision_title: "Participation interests in entities"
section: "960-190"
...
<a id="s960-190-1"></a>
**(1)** Use the following table to work out the direct participation interest that one entity holds in another entity. Direct participation interest

```ingest-unclassified source=vol10.pdf page=83
       If the other entity      the direct participation interest that the first entity
       is this kind of          holds in the other entity is:
       entity:

1      A company (within        the direct control interest (within the meaning of
       the meaning of           section 350 of the Income Tax Assessment Act 1936)
       Part X of the            that the first entity holds in the other entity
       Income Tax
       Assessment Act
       1936)

2      A trust (within the      the direct control interest (within the meaning of
       meaning of Part X        section 351 of the Income Tax Assessment Act 1936)
       of the Income Tax        that the first entity holds in the other entity
       Assessment Act
       1936)

3      A partnership            the direct control interest (within the meaning of
