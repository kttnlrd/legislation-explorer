...
> > **(ii)** a company that has a *shareholding interest in it; (an unequally structured company) has an *unequal share structure.
...
| Item | Column 1 | Column 2 |
| --- | --- | --- |
| 1 | (a) paragraph 165-115C(1)(b) or (c) or 165-115L(1)(b) or (c); | a time that is the time, or one of the times, to which that |
...
> **Note:** If a condition cannot be worked out for several of the times to which the provision relates, apply this Subdivision separately for each of those times. distributions or voting power Section 167-15 Meaning of unequal share structure
