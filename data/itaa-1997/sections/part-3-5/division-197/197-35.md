...
> <a id="s197-35-2-c"></a>
> **(c)** all amounts that were previously transferred to the issuing company's retained profit account in connection with the demutualisation; exceeds the listing day company valuation amount (see subsection (3)), subsection (1) does not stop this Division from

applying to so much of the transferred amount as equals the lesser of the transferred amount and the amount of the excess.
