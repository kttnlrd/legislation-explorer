...
subdivision: "197-B"
subdivision_title: "Consequence of transfer: franking debit arises"
section: "197-45"
...
```ingest-formula source=vol04.pdf page=625
                                          Applicable franking percentage
   Transferred amount                   ________________________________ ×
                                          Applicable gross-up rate
```

where: applicable franking percentage means:
