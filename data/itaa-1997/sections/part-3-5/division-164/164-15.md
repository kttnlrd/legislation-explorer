...
```ingest-formula source=vol04.pdf page=336
...
```ingest-formula source=vol04.pdf page=337
                        Return of           Share capital
Amount received  –                      –
                     amount received       account credit
```
...
that income year, the interest was not in fact, or did not in fact become, an equity interest at that time; the credit referred to in paragraph (a) is taken never to have arisen.
