...
division: "170"
division_title: "Treatment of certain company groups for income tax purposes"
subdivision: "170-A"
subdivision_title: "Transfer of tax losses within certain wholly-owned groups of companies"
section: "170-45"
...
<a id="s170-45-2"></a>
**(2)** The amount transferred also cannot exceed the amount worked out as follows: Method statement Step 1. Add together the *income company's assessable income and *net exempt income (if any) for the *deduction year.
...
• the loss company incurred a tax loss of $50,000. Of the $50,000 loss, the loss company can transfer no more than $30,000 ($60,000+$10,000-$25,000-$15,000) to the income company.
...
are met. In that case, the amount transferred also cannot exceed the amount worked out as follows: Method statement Step 1. Identify each *bundle of losses that, on the assumption in subsection 170-42(2) or (4) (as appropriate), would have included the *tax loss or *film loss (as appropriate).
