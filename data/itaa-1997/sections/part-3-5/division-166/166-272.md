...
> <a id="s166-272-2-d"></a>
> **(d)** the only interests (including shares) in any other entity that is interposed between the stakeholder and the tested company

that are taken into account are exactly the same interests and are held by the same persons. What happens in case of share splitting
...
share) in the company of which the stakeholder or entity is the holder at the start of that period, are consolidated into a new share during that period; and
