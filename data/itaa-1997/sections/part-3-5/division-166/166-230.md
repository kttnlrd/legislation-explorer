...
> <a id="s166-230-3-d"></a>
> **(d)** in any case—each stakeholder holds the same proportion, or a reasonably equivalent proportion, of the total *voting stakes, *dividend stakes or *capital stakes in the new interposed entity immediately after the acquisition as the

stakeholder held in the old interposed entity immediately before the acquisition; then, at all times that the old interposed entity held or is taken to have held a stake in the tested company, the new interposed entity is taken to have held that stake.
...
section 166-272 (which is about the same shares or interests) is to be disregarded when applying subsection (5) of this section.
