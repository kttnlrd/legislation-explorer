...
```ingest-formula source=vol04.pdf page=608
     Beneficiary dividends
   ___________________________      100
        Total dividends
```

where: beneficiary dividends is the total of the *dividends that the *beneficiary has a right to receive because of *shares that the beneficiary holds at that time and are *referable to the *sub-fund.
...
```ingest-formula source=vol04.pdf page=609
     Beneficiary capital distribution
   _____________________________________      100
        Total capital distribution
```

where: beneficiary capital distribution is the amount of a distribution of paid-up capital (in the event of a return of capital) that the *beneficiary has a right to receive because of *shares that the beneficiary holds at that time and are *referable to the *sub-fund.
