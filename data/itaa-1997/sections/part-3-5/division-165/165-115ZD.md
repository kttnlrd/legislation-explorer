...
always to have applied) to the equity or debt, in relation to that last alteration time, as if:
...
> **(b)** the thing has resulted in a reduction of the *reduced cost base of the equity or debt. Things that might expose an unrealised loss netted off by use of global method
...
Things that might expose an unrealised loss netted off by use of global method Item Thing covered 6 The difference between:
