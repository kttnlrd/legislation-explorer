...
```ingest-formula source=vol04.pdf page=377
                                 Previous capital losses, deductions
   Unrealised net loss    –
                                      or trading stock losses
```

where: previous capital losses, deductions or trading stock losses means the total of the following:
