...
```ingest-formula source=vol07.pdf page=55
      Market value of the friendly           Embedded value of the friendly
      society’s health insurance       +     society’s other business (if any)
      business (if any)
   _______________________________________________________________________
   Total *capital proceeds for all entities from *CGT events happeni ng
