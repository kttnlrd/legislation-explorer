...
subdivision: "242-B"
subdivision_title: "Amount to be included in lessor's assessable income"
section: "242-35"
...
```ingest-formula source=vol05.pdf page=484
       Outstanding notional loan principal at
         the start of the lease payment period       × Implicit interest rate
```

where: implicit interest rate is the implicit interest rate under the lease for the *luxury car lease payment period, taking into account the payments to be made by the lessee under the lease and any *termination amounts. outstanding notional loan principal at the start of the lease payment period is:
