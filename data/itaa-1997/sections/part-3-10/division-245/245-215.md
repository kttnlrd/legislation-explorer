...
```ingest-formula source=vol05.pdf page=539
     Partner's share of net income
                                     ´ Residual amount
              Net income
```

where: partner's share of net income means the part of the net income of the partnership for the forgiveness income year that is included in the partner's assessable income.
...
```ingest-formula source=vol05.pdf page=540
     Partner's share of partnership loss
                                          ´ Residual amount
              Partnership loss
```

where: partner's share of partnership loss means the part of the partnership loss that the partner has deducted or can deduct.
