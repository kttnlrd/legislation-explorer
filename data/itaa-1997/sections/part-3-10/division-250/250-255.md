...
> <a id="s250-255-7-a"></a>
> **(a)** if you re-estimate a gain and the amount to which you apply the rate of return increases—you make a gain from the

*financial arrangement, for the income year in which you make the re-estimation, equal to the amount of the increase;
