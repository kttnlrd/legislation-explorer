...
> <a id="s250-65-4-b"></a>
> **(b)** it must be assumed that any right that an entity has to renew or extend such an arrangement will not be exercised (unless it is reasonable to assume that the right will be exercised

because of the commercial consequences for the entity (or a *connected entity) of not exercising the right). Tax preferred uses of asset by entity and connected entity
