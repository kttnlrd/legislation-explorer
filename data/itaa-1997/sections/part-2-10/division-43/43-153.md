...
<a id="s43-153-1B"></a>
**(1B)** For the purposes of subparagraphs (1)(a)(i) and (ii), disregard a requirement determined under subsection (1A) if complying with that requirement would contravene a law of a State or Territory. Affordable dwellings
...
```ingest-formula source=vol02.pdf page=234
     Number of comparable          Number of comparable
     non-affordable dwellings   ³   affordable dwellings
```

where: number of comparable affordable dwellings means the number of the dwellings (including the test dwelling) that:
