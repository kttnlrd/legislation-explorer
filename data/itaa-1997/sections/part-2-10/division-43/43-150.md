...
> 
> **(v)** the storage, within premises in which core activities are carried on, or premises contiguous to those premises, of goods in carrying on core activities, goods in relation to

which core activities have commenced but not finally been completed or goods resulting from core activities; but does not include the preparation of food or drink (whether for consumption on the premises where it is prepared or elsewhere) in, or in premises occupied in connection with, a hotel, motel, boarding house, catering establishment, restaurant, cafe, milk-bar, coffee shop, retail shop or similar establishment. Build to rent developments
