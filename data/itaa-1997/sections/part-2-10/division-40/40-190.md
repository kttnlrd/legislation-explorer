...
<a id="s40-190-3"></a>
**(3)** However, the second element is worked out using this table if an item in it applies. Use the last applicable item. Second element of the cost of a depreciating asset
