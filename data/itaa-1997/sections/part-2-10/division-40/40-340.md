...
```ingest-unclassified source=vol02.pdf page=108
Item  Type of CGT roll-over    Conditions

1     Disposal of asset to     The transferor is able to choose a roll-over
      wholly-owned company     under Subdivision 122-A for the *CGT event.
```
...
<a id="s40-340-7"></a>
**(7)** The transferee must keep the choice or a copy of it until the end of 5 years after the next *balancing adjustment event occurs for the *depreciating asset. Penalty: 30 penalty units.
