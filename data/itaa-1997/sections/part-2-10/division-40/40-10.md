...
The key concepts about depreciating assets and certain other capital expenditure are outlined below (in bold italics). Simplified outline of this Division

```ingest-unclassified source=vol02.pdf page=28
...
| Item | Major topic Subordinate topics Rules | Provisions |
| --- | --- | --- |
...
```ingest-unclassified source=vol02.pdf page=31
Item   Major topic                                                 Provisions
       Subordinate topics
       Rules

2.4    Capital expenditure for establishing trees in carbon        Subdivision 40-J
       sink forests
