...
> <a id="s40-305-1-a"></a>
> **(a)** the sum of the amounts you have deducted or can deduct, or has been or will be taken into account in working out an amount you can deduct because of the balancing adjustment event and any amount by which the amount so deductible

was reduced because of a case described in the table in this subsection; and

> <a id="s40-305-b"></a>
> **(b)** the sum of the applicable amounts set out in that table: Amount you are taken to have received under a balancing adjustment event
