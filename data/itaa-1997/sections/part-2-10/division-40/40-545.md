...
write-off days in income year is the number of days in the income year on which you satisfied a condition in subsection 40-525(2) for the plant and either used it for *commercial horticulture or held it ready for that use. write-off rate is the rate shown in this table for the *horticultural plant according to its *effective life. Write-off rate for horticultural plant
...
> <a id="s40-545-3-b"></a>
> **(b)** extends for the time shown in this table (depending on the plant’s *effective life). Period after which you cannot count use of horticultural plant
