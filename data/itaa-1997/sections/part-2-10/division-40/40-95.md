...
> <a id="s40-95-6-a"></a>
> **(a)** you do not know, and cannot readily find out, which effective life the former holder was using and, if subsection (5B) or

**(5C)** applied to the asset, either of the following matters:
...
<a id="s40-95-7"></a>
**(7)** The effective life of an intangible *depreciating asset mentioned in this table is the period applicable to that asset under the table. Effective life of certain intangible depreciating assets
...
*mining, quarrying or prospecting right cannot be longer than the term of the asset as extended by any reasonably assured extension or renewal of that term.
...
| Item | Column 1 For this asset: | Column 2 Estimate the period until the end of: |
| --- | --- | --- |
...
```ingest-unclassified source=vol02.pdf page=67
3   A *mining, quarrying or prospecting      The life of the quarry or proposed
    right, or *mining, quarrying or          quarry to which the right or
    prospecting information, relating to     information relates or, if there is
```

Effective life of certain mining, quarrying or prospecting rights and mining, quarrying or prospecting information

```ingest-unclassified source=vol02.pdf page=68
Item   Column 1                              Column 2
       For this asset:                       Estimate the period until the end
                                             of:
       *mining and quarrying operations to   more than one, the life of the quarry
       obtain quarry materials               that has the longest estimated life
```
