...
<a id="s40-95-1-b"></a>
**(b)** to work out the effective life of the asset yourself under section 40-105. Chapter 2 Capital allowances: rules about deductibility of capital expenditure 
...
**Note:** You can require the associate to tell you the relevant time that applied to the associate under subsection 40-102(3): see section 40-140.  (4C) For a *depreciating asset that you start to *hold if:
...
<a id="s40-95-5-f"></a>
**(f)** if the former holder was using the *prime cost method—an effective life equal to the capped life that: Chapter 2 Capital allowances: rules about deductibility of capital expenditure 
<a id="s40-95-5-f-i"></a>
...
<a id="s40-95-12-c"></a>
**(c)** a quarry or proposed quarry. Chapter 2 Capital allowances: rules about deductibility of capital expenditure 
---
