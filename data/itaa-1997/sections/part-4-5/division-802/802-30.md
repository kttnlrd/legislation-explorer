...
```ingest-formula source=vol09.pdf page=297
                                     (1     *Corporate tax rate)
   Available franking credit      _______________________________
                                         *Corporate tax rate
```

where: available franking credit means any part of the amount remaining after subsection (3) to the extent to which a *franking credit arises or will arise for the entity.
