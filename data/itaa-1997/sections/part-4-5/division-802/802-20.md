...
part_title: "General"
division: "802"
division_title: "Foreign residents’ income with an underlying foreign source"
subdivision: "802-A"
...
```ingest-formula source=vol09.pdf page=294
                                       Total declared
                                        CFI amounts
   Total received       ______________________________________
    CFI amounts          Total received
                          CFI amounts         Related expenses
```

where: related expenses means the receiving entity’s expenses that are reasonably related to the total received CFI amounts.
