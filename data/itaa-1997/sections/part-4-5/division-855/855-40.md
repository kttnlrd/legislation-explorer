...
<a id="s855-40-6-b"></a>
**(b)** a *fixed trust in which the first trust has an interest (directly, or indirectly through a *chain of trusts, each trust in which is a fixed trust);  must not be *taxable Australian property at the time of the relevant *CGT event.
