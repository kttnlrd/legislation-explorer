...
<a id="s855-30-4"></a>
**(4)** For the purposes of subsection (2), treat the *market value of the TARP asset and the non-TARP asset according to the following table. Market value of the TARP asset and the non-TARP asset

```ingest-unclassified source=vol09.pdf page=678
Item   If:                       the market value of      the market value of
                                 the TARP asset is:       the non-TARP asset
                                                          is:

1      the sum of the *total     zero                     the *market value of
       participation interests                            the *membership
       held by the holding                                interest mentioned in
       entity and its                                     subsection (3)
       *associates in the
...
```ingest-unclassified source=vol09.pdf page=679
Item   If:                       the market value of      the market value of
                                 the TARP asset is:       the non-TARP asset
                                                          is:
...
2      item 1 does not apply     the product of:          the product of:
                                 ...
                                 (a) the sum of the       (a) the sum of the
                                     *market values of        market values of
                                     all the assets of the    all the assets of the
                                     other entity that        other entity that
                                     are *taxable             are not taxable
                                     Australian real          Australian real
                                     property; and            property; and

                                 (b) the first entity’s   (b) the first entity’s
                                     *direct                  direct participation
                                     participation            interest in the other
...
<a id="s855-30-5"></a>
**(5)** For the purposes of this section, disregard the *market value of any asset acquired by the test entity, or by any other entity, if the *acquisition was done for a purpose (other than an incidental

purpose) that included ensuring that a *membership interest in any entity would not pass the principal asset test in this section.
