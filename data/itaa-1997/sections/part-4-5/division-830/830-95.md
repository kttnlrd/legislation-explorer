...
subdivision: "830-D"
subdivision_title: "Special rules applicable when an entity becomes or ceases to be a foreign hybrid"
section: "830-95"
...
Method statement Step 1. Work out what would have been the entity’s *tax cost of the asset for the purposes of applying the *asset-based income tax regime as at the start of the hybrid year if it were not a *foreign hybrid in relation to the hybrid year. Step 2. Multiply the result of step 1 by:
...
```ingest-formula source=vol09.pdf page=560
        Result of step 1 in the method
          statement in subsection (1)              Excess mentioned in step 3
                                                     in the method statement
        Sum of results of step 1 in the                in this subsection
      method statement in subsection (1)
            for the partner for all of
     the *foreign hybrids assets in relation
    to the *asset -based income tax regime
```
