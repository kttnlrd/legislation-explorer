...
> <a id="s820-120-4-b"></a>
> **(b)** the amount of each *debt deduction to be disallowed; sections 820-90 to 820-115 apply in relation to that entity and that period with the modifications set out in the following table: Modifications of sections 820-90 to 820-115

```ingest-unclassified source=vol09.pdf page=384
