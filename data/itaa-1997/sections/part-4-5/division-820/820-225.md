...
> <a id="s820-225-3-b"></a>
> **(b)** the amount of each *debt deduction to be disallowed; sections 820-190 to 820-220 apply in relation to that entity and that period with the modifications set out in the following table: Modifications of sections 820-190 to 820-220
...
```ingest-unclassified source=vol09.pdf page=403
Item   Provisions        Modifications
3      Section 820-220   adjusted average debt is taken to have the
