...
> **Note:** A consolidated group or MEC group may be an outward investing financial entity (non-ADI) to which this Subdivision applies: see Subdivisions 820-FA and 820-FB. Outward investing financial entity (non-ADI)
...
| Item | If: | and: | then: |
| --- | --- | --- | --- |
| 1 | the entity (the relevant entity) is one or both of the following throughout a period that is all or a part of an income year: | the relevant entity is a *financial entity | the relevant entity is an outward investing |

| (a) an *Australian controller of at least | throughout | financial |
| --- | --- | --- |
| one *Australian controlled foreign | that period | entity |
| entity (not necessarily the same |  | (non-ADI) for |
| Australian controlled foreign entity |  | that period |
...
| 2 | (a) the entity (the relevant entity) is an | the relevant | the relevant |
| --- | --- | --- | --- |

| (b) throughout that period, the relevant | throughout | financial |
| --- | --- | --- |
| entity is an *associate entity of | that period | entity |
| another Australian entity; and |  | (non-ADI) for |
