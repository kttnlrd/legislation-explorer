...
> <a id="s820-910-3-d"></a>
> **(d)** the terms and conditions for each of the interests are those that would apply if the relevant entity and the relevant

associate entity that issued the interest were dealing at *arm’s length with each other.
