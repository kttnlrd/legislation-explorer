...
Method statement Step 1. For each controlled entity, work out the amount (if any) by which the *fixed ratio earnings limit of the controlled entity for the income year exceeds the sum of the following:
...
Step 5. Divide the result of step 4 by 0.3. The result of this step is the excess tax EBITDA amount. Modification of TC direct control interest—companies
