...
```ingest-formula source=vol09.pdf page=375
        Average Australian assets of the entity
   ______________________________________________________________
   *Statement worldwide assets of the entity for the income year
```

where: average Australian assets of an entity is the average value, for the statement period mentioned in subsection (4), of all the assets of the entity, other than:
