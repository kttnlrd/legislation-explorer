...
<a id="s775-210-3"></a>
**(3)** The table has effect if an *eligible security is rolled-over under a *facility agreement: Roll-over of eligible security

```ingest-unclassified source=vol09.pdf page=263
Item   If the foreign currency face      this is the result...
       value of the new security...
1      equals the *foreign currency      (a) the period of each notional loan
       face value of the rolled-over         attached to the rolled-over security is
       security                              extended by the term of the new
                                             security; and
...
| --- | --- | --- |
| 2 | exceeds the *foreign currency face value of the rolled-over security | (a) you are taken to have been given an additional notional loan: (i) of a foreign currency principal amount equal to the excess; and (ii) for a period equal to the term of the new security; and (iii) that is taken to be attached to the new security; and (iv) the start time of which is the time when you issued the new security; and (b) the period of each notional loan attached to the rolled-over security is extended by the term of the new security; and (c) each notional loan attached to the rolled-over security is taken to be attached to the new security. |
...
```ingest-unclassified source=vol09.pdf page=265
Item   If the foreign currency face      this is the result...
       value of the new security...
4      falls short of the *foreign       (a) you are taken to have paid a foreign
       currency face value of the            currency amount equal to the shortfall
       rolled-over security, and             in order to discharge your obligation to
       there are 2 or more notional          pay so much of the total foreign
       loans attached to the                 currency principal amounts of the
       rolled-over security                  notional loans as equals the shortfall,
