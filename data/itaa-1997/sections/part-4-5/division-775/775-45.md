...
> **Note 2:** For extended meaning of right to receive foreign currency, see section 775-135. Time of event
...
> **Note 3:** For currency exchange rate effect, see section 775-105. Forex realisation loss
...
```ingest-unclassified source=vol09.pdf page=224
Item   If the right, or part of the right, is...     the tax recognition time is...

1      a right, or a part of a right, to receive,    (a) in the case of ordinary income—
       or that represents, *ordinary income              when the ordinary income is
       or *statutory income (other than                  *derived; or
       statutory income that is assessable
       under this Division or Division 102)          (b) in the case of statutory
