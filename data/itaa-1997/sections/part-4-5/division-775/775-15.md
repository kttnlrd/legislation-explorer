...
> <a id="s775-15-2-b"></a>
> **(b)** is not covered by an item of the table: Forex realisation gains to which this subsection does not apply

```ingest-unclassified source=vol09.pdf page=216
Item   You make the          happening to...                 and the following
       forex realisation                                     condition is satisfied...
       gain as a result of
       this event...
1      forex realisation     *foreign currency or a right, or a gain that would result
       event 1 or 2          a part of a right, to receive   from the occurrence of a
                             foreign currency                *realisation event in
