...
| --- | --- | --- |
| 1 | any of the following: | the conditions operate at or |
...
> <a id="s815-120-3-c"></a>
> **(c)** a partnership in which all of the partners are, directly or indirectly through one or more interposed partnerships,

**Australian residents or resident trust**

| estates 2 | an entity not covered by column 1 of item 1 | the conditions do not operate |
| --- | --- | --- |
