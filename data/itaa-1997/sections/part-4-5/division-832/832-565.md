...
<a id="s832-565-2"></a>
**(2)** So much of the amount of *dual inclusion income that satisfies paragraph (1)(b) as does not exceed the amount that was not

allowable as a deduction is an amount the entity can deduct in the adjustment year.

<a id="s832-565-2A"></a>
**(2A)** Subsection (2) does not apply if:

> <a id="s832-565-2A-a"></a>
> **(a)** the amount that was not allowable as a deduction under section 832-530 relates to a payment; and

> <a id="s832-565-2A-b"></a>
