...
<a id="s832-330-1"></a>
**(1)** The neutralising amount for a *hybrid payer mismatch is the amount of the *hybrid mismatch from subsection 832-310(2),

reduced (but not below nil) by the amount of any *dual inclusion income that is available to be applied in working out the neutralising amount. Australian deduction—inclusions must be in Australia and in the non-including country
