...
<a id="s832-210-2"></a>
**(2)** The question whether a *hybrid mismatch is a design feature of a *scheme must be determined by reference to the facts and

circumstances that exist in connection with the scheme, including the terms of the scheme.
