...
```ingest-formula source=vol09.pdf page=630
                                    Remaining offshore
     Importing deduction            hybrid mismatch
Total importing deductions of equal priority
```

where: importing deduction means the amount of the importing deduction amount worked out under subsection (2) in relation to the deduction. remaining offshore hybrid mismatch means:
