...
> <a id="s832-110-5-ii"></a>
> **(ii)** that share is brought to account in that tax base on an item-by-item basis, instead of on a net basis; the amount is taken for the purposes of subsection (1) to also give rise to a *foreign income tax deduction in the foreign country, for an amount representing the share in the net loss of the partnership,

and equal to the amount of the deduction mentioned in paragraph (a).
