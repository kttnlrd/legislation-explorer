...
> <a id="s832-130-4-c"></a>
> **(c)** the entity is entitled to a *foreign income tax deduction in respect of all or part of the amount of the dividend; then only so much of the pre-deduction amount as reasonably represents an amount not effectively sheltered from *foreign

income tax (except a tax covered by subsection (7)) by the foreign income tax deduction is subject to foreign income tax. Effect of CFC regimes
