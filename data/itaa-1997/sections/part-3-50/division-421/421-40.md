...
> <a id="s421-40-1-ii"></a>
> **(ii)** if the facility that produced the hydrogen is connected to an electricity grid—that the electricity (if any) that the

facility obtained from the grid and used to produce the kilogram of hydrogen satisfies the *grid matching requirements; and
...
that specifies the facility at which the hydrogen was produced;
