...
```ingest-formula source=vol01.pdf page=36
...
```ingest-unclassified source=vol01.pdf page=38
Item   For this case ...                        See:
6.     The Commissioner makes a                 section 24 of the
       determination of the amount of taxable   International Tax
       income to prevent double taxation in     Agreements Act 1953
