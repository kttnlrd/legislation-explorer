...
division: "58"
division_title: "Capital allowances for depreciating assets previously owned by an exempt entity"
subdivision: "58-B"
subdivision_title: "Calculating decline in value of privatised assets under Division 40"
section: "58-75"
...
> <a id="s58-75-4-a"></a>
> **(a)** assume that the transition entity or tax exempt vendor acquired it at the time when it was acquired or constructed by the other exempt Australian government agency and that the first element of its *cost to the transition entity or tax exempt _____________________________________
...
> <a id="s58-75-5A-c"></a>
> **(c)** the *transition entity chooses, for the purposes of this section, to have section 40-102 apply to the asset. If section 40-102 is to be applied to the asset, disregard paragraphs 40-102(2)(a) and (b) and assume that the relevant time for the _____________________________________

purposes of the application of that section to the asset were the transition time.
