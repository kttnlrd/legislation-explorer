...
> **Example:** Continuing example 1 in section 84-5: Assume that NewIT only provides services to one client. Ron's assessable income includes

ordinary income of NewIT from providing the computer programming services, because the income is Ron's personal services income.
