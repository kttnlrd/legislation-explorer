...
| 24C | An entity ceases to be a subsidiary member of a consolidated group and an asset becomes an asset of | The total cost base and reduced cost base for the entity of a liability owed to the entity | Section 701-45 |

Modifications outside this Part and Part 3-3

| Item | In this situation | Element affected: | See: |
| --- | --- | --- | --- |
|  | the entity because the single entity rule ceases to apply |  |  |
...
```ingest-unclassified source=vol03.pdf page=371
Item   In this situation             Element affected:        See:

25     You make a forex              total cost base and      section 775-70
       realisation gain as a result  reduced cost base
       of forex realisation event
       4, and:
       (a) you incurred the
           obligation to pay
           foreign currency:
...
```ingest-unclassified source=vol03.pdf page=372
Item   In this situation             Element affected:        See:

26     You make a forex              total cost base and      section 775-75
       realisation loss as a result  reduced cost base
       of forex realisation event
       4, and:
       (a) you incurred the
           obligation to pay
