...
> **Note 2:** Any capital gain or loss the trust estate makes from the sale on 30 June 2027 is disregarded (and deferred) until the income year in

which the realisation event happens. The trustee (and beneficiaries) can wait until then before working out the amount of the capital gain or loss (see section 112-170).
