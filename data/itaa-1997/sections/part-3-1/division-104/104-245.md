...
| --- | --- | --- | --- | --- |
| w | here: |  |  |  |
| t | axable use fraction is the t | axab | le use percentage (express | ed as a |
| f | raction) that you estimated | for | the asset when you allocat | ed it to |
| t | he pool. |  |  |  |
...
| --- | --- | --- | --- | --- |
| w | here: |  |  |  |
| t | axable use fraction has the | same | meaning as in subsection | (1). |
