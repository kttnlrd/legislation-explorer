...
> **Example:** You dispose of your interest in the trust capital for $10,000 (the capital proceeds). The total of the cost bases of the CGT assets that the trustee acquired on or after 20 September 1985 is $6,000. The total of the market values of the CGT assets that the trustee acquired before 20 September 1985 is $2,500. There is $1,000 in the trust. The trust liabilities are $500.
>
> The net asset amount is:

```ingest-formula source=vol03.pdf page=227
...
```ingest-formula source=vol03.pdf page=228
                             The part of the interest you are disposing of
   The net asset amount  ´            (expressed as a fraction)
```
...
<a id="s104-95-4"></a>
**(4)** If you are _not_ the only beneficiary with an interest in the trust capital and you *dispose of your interest, any *capital gain is worked out using the method statement in subsection (1), except that the Step 2 amount is replaced by:
...
<a id="s104-95-5"></a>
**(5)** If you are _not_ the only beneficiary with an interest in the trust capital and you *dispose of _part_ of your interest, any *capital gain is worked out using the method statement in subsection (1), except that the Step 2 amount is replaced by:

```ingest-formula source=vol03.pdf page=229
                     Your interest in            The part of the interest
   The net asset  ´  the trust capital       ´   you are disposing of
   amount            (expressed as a fraction)   (expressed as a fraction)
```
