...
<a id="s104-145-1"></a>
**(1)** CGT event G3 happens if you own *shares in a company, or financial instruments issued by or created by or in relation to a company, and a liquidator or administrator of the company

declares in writing that the liquidator or administrator has reasonable grounds to believe (as at the time of the declaration) that:
