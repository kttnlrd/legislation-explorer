...
> **Note:** A payment made to you after you stop owning the unit or interest in the trust forms part of the capital proceeds for the CGT event that happened when you stopped owning it. (1A) However, CGT event E4 does not happen if the unit or interest mentioned in subsection (1) is a unit or interest in an *AMIT.
