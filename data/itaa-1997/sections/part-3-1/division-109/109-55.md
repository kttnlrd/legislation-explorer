...
This table sets out other acquisition rules in this Part and Part 3-3. Some of the rules have effect only for limited purposes. Other acquisition rules

```ingest-unclassified source=vol03.pdf page=310
Item   In these circumstances                       You acquire the asset at this time:   See:
1      A CGT asset devolves to you as legal         when the individual died               section 128-15
