...
```ingest-formula source=vol03.pdf page=476
                     177              100%
      $450     ×            ×
                     365            7 years
```

```ingest-formula source=vol03.pdf page=477
      = $31
```
...
> Due to the balancing adjustment event that occurred on 2 January 2002, $54 is included in Gayle's assessable income for the 2001-02 income year under section 40-285. The amount is reduced for non-taxable use by section 40-290. A capital gain of $202 is disregarded under this section because the asset is a collectable acquired for less than $500.
