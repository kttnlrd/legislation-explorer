...
```ingest-formula source=vol03.pdf page=521
CG or CL amount ´   Non-main residence days
                    Days in that period
```

where: CG or CL amount is the *capital gain or *capital loss you would have made from the *CGT event apart from this Subdivision. non-main residence days is the number of days in that period when the *dwelling was not the individual's main residence.
