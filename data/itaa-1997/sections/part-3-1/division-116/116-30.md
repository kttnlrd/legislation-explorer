...
> <a id="s116-30-2-ii"></a>
> **(ii)** the CGT event is CGT event C2 (about cancellation, surrender and similar endings). (The market value is worked out as at the time of the event.)
...
<a id="s116-30-4"></a>
**(4)** To avoid doubt, the *CGT asset that is the subject of a *CGT event specified in this table is the asset so specified. *CGT assets the subject of certain events
