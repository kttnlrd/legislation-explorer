...
> **Note 2:** The assumption that a CGT event happens does not have any consequence beyond that stated. For example, it does not mean that

the asset is afterwards to be treated as having been acquired at the particular time with a first element of cost base equal to all of its former cost base elements.
