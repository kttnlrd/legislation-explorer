...
> <a id="s110-55-3-ii"></a>
> **(ii)** if Division 58 applies to the asset and an amount has been included in your assessable income for an income

year because of a balancing adjustment for the asset— any part of that amount that was attributable to amounts you have deducted or can deduct for the decline in value of the asset; and
...
```ingest-formula source=vol03.pdf page=340
