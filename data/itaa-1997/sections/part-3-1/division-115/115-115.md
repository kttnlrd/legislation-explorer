...
```ingest-formula source=vol03.pdf page=425
...
```ingest-formula source=vol03.pdf page=425
    Number of days in     -    Number of apportionable days that you
  discount testing period      were a foreign resident or *temporary resident
...
| Item | Column 1 If the excess from paragraph (d): | Column 2 then, the percentage is: |
| --- | --- | --- |
...
```ingest-formula source=vol03.pdf page=427
                          Shortfall  ´   Number of apportionable days that
                                             you were an eligible resident
            Excess
