...
```ingest-formula source=vol05.pdf page=59
...
applicable gross-up rate means the *corporate tax gross-up rate of the entity making the distribution for the income year in which the distribution is made. franking % differential is the difference between:
...
```ingest-formula source=vol05.pdf page=60
            100 -
             90 -
             80 -
                                                                     Distribution 3 (over-franked)
             70 -
Franking                       Distribution 1 (correctly             franking
percentage   60 -                                                       %
                                        franked)                    differential
             50 -              Distribution 2 (under-franked)
                                            franking
             40 -                              %
                                           differential
             30 -
