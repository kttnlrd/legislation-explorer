...
where: net financial benefit means an amount equal to the *financial benefit that is referable to the *franked distribution (after any application by the trustee of expenses that are directly relevant to the franked distribution). share of net financial benefit means an amount equal to the *financial benefit that, in accordance with the terms of the trust:
