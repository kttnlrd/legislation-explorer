...
subdivision: "207-D"
subdivision_title: "No gross-up or tax offset where distribution would not be taxed"
section: "207-95"
...
> <a id="s207-95-5-b"></a>
> **(b)** a part of the entity's *share of the distribution (the relevant part) would, in its hands, be *exempt income or *non-assessable non-exempt income(whether or not it had actually received that part); then, subsection (2), (3) or (4) (as appropriate) applies to the entity on the basis that the amount of its *share of the *franking credit on the distribution is worked out as follows:

```ingest-formula source=vol05.pdf page=129
                Relevant part                           Entity's *share
                                             ´    of the *franking credit on
             Entity's *share                       the *franked distribution
     of the *franked distribution                   apart from this section
```
...
```ingest-formula source=vol05.pdf page=129
                  Entity's *share of
               the *franking credit on the                Amount worked out
     *franked distribution apart from this section       under subsection (5)
```
