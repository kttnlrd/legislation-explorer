...
income for that year that is attributable to all or a part of the distribution.
...
> <a id="s207-35-5-b"></a>
> **(b)** the assessable income of the trust for that year includes an amount (the franking credit amount) that is all or a part of

the additional amount of assessable income included under subsection (1) in relation to the distribution; and
