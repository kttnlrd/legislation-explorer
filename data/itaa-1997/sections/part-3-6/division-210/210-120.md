...
```ingest-unclassified source=vol05.pdf page=219
Item   If:                      A debit of:             Arises on:
1      the *PDF makes a         the amount of the       the day on which the
       *distribution *franked   *venture capital        distribution is made
       with                     credit
