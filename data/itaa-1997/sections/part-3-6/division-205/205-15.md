...
```ingest-unclassified source=vol05.pdf page=81
Item  If:                       A credit of:            Arises:

1     the entity *pays a PAYG   that part of the payment  on the day on which the
      instalment; and           that is attributable to   payment is made
                                the period during
      the entity satisfies the  which the entity was a
      *residency requirement    franking entity, less
      for the income year in    any reduction under
