...
<a id="s205-30-1"></a>
**(1)** The following table sets out when a debit arises in the *franking account of an entity and the amount of the debit. The debit is called a franking debit. Debits in the franking account

```ingest-unclassified source=vol05.pdf page=89
Item   If:                     A debit of:                Arises:
1      the entity *franks a    the amount of the          on the day on which
       *distribution           *franking credit on the    the distribution is made
                               distribution
```
...
```ingest-unclassified source=vol05.pdf page=93
Debits in the franking account
Item   If:                          A debit of:                 Arises:
9      (a) the entity purchases a   an amount equal to the      on the day on which
           *membership interest     debit that would have       the interest is
           in itself; and           arisen if:                  purchased
       (b) the purchase is an       (a) the purchase of the
           *on-market buy-back;         interest were a
           and                          *frankable
       (c) the entity is a              distribution equal to
           company                      the one that would
                                        have arisen if the
                                        entity:
                                        (i) purchased the
                                            interest
...
```ingest-unclassified source=vol05.pdf page=94
Debits in the franking account
Item   If:                          A debit of:                 Arises:
9A     (a) the entity purchases a   an amount equal to the      on the day on which
           *membership interest     debit that would have       the interest is
           in itself; and           arisen if:                  purchased
       (b) the purchase is an       (a) the purchase of the
           *off-market                  interest were a
           buy-back; and                *frankable
       (c) the entity is a *listed      distribution equal to
           public company               the one that would
                                        have arisen if the
                                        entity were not a
                                        listed public
                                        company; and
...
| Item | If: | A debit of: | Arises: |
| --- | --- | --- | --- |
| 9B | the entity makes a *distribution to which paragraph 202-45(k) applies (consideration for cancellation of membership interest as part of selective reduction of capital) | an amount equal to the debit that would have arisen if: (a) the distribution were a *frankable distribution equal to the one that would have arisen if the entity were not a *listed public company; and (b) the distribution were *franked at the entity’s *benchmark franking percentage for the *franking period in which the distribution was made or, if the entity does not have a benchmark franking percentage for the period, at a *franking percentage of 100% | on the day on which the distribution is made |
...
```ingest-unclassified source=vol05.pdf page=97
Item   If:                         A debit of:                  Arises:
14     the entity *receives a      that part of the refund      on the day on which
       refund of Australian        that is attributable to the  the refund is received
       DMT tax; and                period during which the
                                   entity was a franking
       the entity satisfies the    entity
