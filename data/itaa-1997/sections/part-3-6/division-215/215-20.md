...
```ingest-formula source=vol05.pdf page=250
*Franking credit on the dividend ´ Applicable gross-up rate
```

where: applicable gross-up rate means the *corporate tax gross-up rate of the entity making the distribution for the income year in which the distribution is made.
