...
> <a id="s215-25-1-e"></a>
> **(e)** it is reasonable to expect that, having regard to the available profits mentioned in paragraph (d), the amount of the entity's *adjusted available frankable profits immediately after each of the committed distributions is paid will be greater than nil. The available frankable profits immediately before the entity pays the non-share dividend is then the smallest of the amounts of the adjusted available frankable profits mentioned in paragraph (e).
