...
subdivision: "219-B"
subdivision_title: "Franking accounts of life insurance companies"
section: "219-15"
...
```ingest-unclassified source=vol05.pdf page=260
Item   If:                              A credit of:                      Arises:
1      the company *pays a              that part of the payment          on the day on which
       PAYG instalment; and             that:                             the payment is made
       the company satisfies the        (a) the company estimates         (see note 1 to this
       *residency requirement               will be attributable to       subsection)
       for the income year in               the *shareholders’
       relation to which the                share of the *income
       PAYG instalment is                   tax liability of the
       paid; and                            company for that
       the payment is made                  income year; and
       before the company’s             (b) is attributable to the
       *assessment day for that             period during which
       income year; and                     the company was a
...
```ingest-unclassified source=vol05.pdf page=263
Item   If:                              A credit of:                      Arises:
6      a *franked distribution          the amount of the tax             at the time specified
       *flows indirectly to the         offset                            in subsection (3)
       company through a
...
```ingest-unclassified source=vol05.pdf page=265
Item   If:                              A credit of:                      Arises:
9      the company *pays                that part of the payment          on the day on which
       diverted profits tax; and        that is attributable to:          the payment is made
       the company satisfies the        (a) the *shareholders’ share
       *residency requirement               of the *income tax
       for the income year for              liability of the
       which the tax is paid; and           company for that
       the company is a                     income year; and
       *franking entity for the         (b) the period during
       whole or part of that                which the company
       income year                          was a franking entity;
                                        multiplied by the
