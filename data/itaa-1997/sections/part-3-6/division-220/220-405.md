...
subdivision: "220-C"
subdivision_title: "Modifications of other Divisions of this Part"
section: "220-405"
...
```ingest-formula source=vol05.pdf page=292
   Amount of the
   supplementary    ´     Entity’s *share of the *franked distribution
     dividend                Amount of the *franked distribution
```
