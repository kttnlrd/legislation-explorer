...
```ingest-unclassified source=vol05.pdf page=176
Item  If:                             A credit of:                  Arises:

1     the entity had a *franking      an amount equal to:           immediately
      surplus at the time it became                                 after its
      a *former exempting entity      (a) in a case not covered     transition
      (at the time of its transition)     by paragraph (b)—the
                                          franking surplus; or
...
```ingest-unclassified source=vol05.pdf page=177
Item  If:                             A credit of:            Arises:

2     the entity receives a           an amount worked out    on the day
      *distribution *franked with    under                   on which the
      an exempting credit; and       subsection 208-165(1)    distribution
                                                             is made
...
```ingest-unclassified source=vol05.pdf page=178
Item  If:                             A credit of:            Arises:

3     the entity receives a           an amount worked out    on the day
      *distribution *franked with    under                   on which the
      an exempting credit; and       subsection 208-170(1)    distribution
                                                             is made
      the entity satisfies the
      *residency requirement for
      the income year in which the
