...
> <a id="s727-630-2-b"></a>
> **(b)** the amount (if any) by which section 727-615 or 727-850 reduces a loss worked out under section 977-10 (about realisation events for CGT assets) that would, apart from this

Division, be *realised for income tax purposes by the event is not taken into account; in working out the total loss reductions.
