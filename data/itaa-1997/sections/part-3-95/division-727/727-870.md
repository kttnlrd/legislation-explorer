...
> <a id="s727-870-1-c"></a>
> **(c)** there is a roll-over for the CGT event; the interest’s *reduced cost base at the time of the CGT event is taken to have been reduced by the amount by which section 727-850 reduces that loss, but is so taken only for the purposes of working out:
