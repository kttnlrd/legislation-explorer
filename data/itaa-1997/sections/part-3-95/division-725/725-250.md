...
```ingest-unclassified source=vol09.pdf page=67
Item  To the extent that the        To:                        The decrease or
      direct value shift is                                    uplift is worked out
      from:                                                    under:
10    *down interests owned         *up interests owned by     (there are no
      by entities that are not      you                        decreases or uplifts)
      *affected owners
```
