...
<a id="s20-125-3"></a>
**(3)** You increase the first 2 limits if you, or your associate, have previously leased the *car from the same lessor, or from an associate of that lessor. You increase the first limit by the total lease payments for each previous lease of that kind that you, your *associate or another entity have deducted or can deduct under this Act for an income year. You increase the second limit by the amount of *notional depreciation for the period of each previous lease of that kind. Successive leases
