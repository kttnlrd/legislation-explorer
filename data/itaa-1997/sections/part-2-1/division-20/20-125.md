...
> <a id="s20-125-1-c"></a>
> **(c)** the car was leased to you or your *associate; and _____________________________________
...
> <a id="s20-125-2-c"></a>
> **(c)** if an entity other than you, or if entities including you, acquired the *car from the lessor—the amount by which the *consideration receivable for the disposal of the car by you exceeds the total of: _____________________________________
...
<a id="s20-125-3"></a>
**(3)** You increase the first 2 limits if you, or your associate, have previously leased the *car from the same lessor, or from an associate of that lessor. You increase the first limit by the total lease payments for each previous lease of that kind that you, your *associate or another entity have deducted or can deduct under this Act for an income year. _____________________________________

You increase the second limit by the amount of *notional depreciation for the period of each previous lease of that kind. Successive leases
