...
<a id="s20-65-4"></a>
**(4)** The assessable income of each deducting entity for the assessment year includes the total amounts (if any) by which that entity’s _____________________________________

actual deductions for the loss or outgoing are reversed in that income year.
