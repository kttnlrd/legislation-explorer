...
• the amount it cost you to acquire the *car; plus:
...
```ingest-unclassified source=vol01.pdf page=153
Consideration receivable for the disposal of the car

Item   In this situation:                      the consideration receivable is:
1      you sell the *car for an amount         the proceeds of the sale, less the
       specific to it                          expenses of the sale
```
