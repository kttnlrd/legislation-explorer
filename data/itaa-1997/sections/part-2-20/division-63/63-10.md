...
<a id="s63-10-1"></a>
**(1)** If you have one or more *tax offsets for an income year, apply them against your basic income tax liability in the order shown in the table. To the extent that an amount of a tax offset remains, the table tells you what happens to it. Order of applying tax offsets
...
> **Note 5:** Tax offsets mentioned in items 5 and 10 are more commonly referred to as the Senior Australians Tax Offset. _____________________________________

<a id="s63-10-2"></a>
**(2)** Within each item, apply the tax offsets in the order in which they arose.

> **Note:** This would be relevant if you have carry forward tax offsets of the same category for different income years. _____________________________________
