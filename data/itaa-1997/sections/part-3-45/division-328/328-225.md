...
```ingest-formula source=vol07.pdf page=170
                                      Present year
Reduction factor      Asset value     estimate        – Last estimate
```
...
```ingest-formula source=vol07.pdf page=171
        (          )
        ç   rate   ÷                        n – 1
   1 –  ç          ÷        1 –  rate
        ç    2     ÷
