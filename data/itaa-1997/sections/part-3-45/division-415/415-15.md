...
| where: |  |  |
| eligible portion of the later inc | ome year means the amou | nt worked |
| out using the following formula: |  |  |
 Number of days in the later income year on which subsection (2) applies to the entity Number of days in the later income year
