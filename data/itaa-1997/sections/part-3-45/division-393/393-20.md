...
> > **(ii)** at all times while the deposit is with the FMD provider, contains requirements to the effect set out in the table in section 393-35. The agreement may also contain additional requirements that are not inconsistent with those set out in that table. Depositor to provide information in application form
