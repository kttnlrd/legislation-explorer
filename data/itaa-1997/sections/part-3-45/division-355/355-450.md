...
subdivision: "355-G"
subdivision_title: "Clawback of R&D recoupments, feedstock adjustments and balancing adjustments"
section: "355-450"
...
```ingest-formula source=vol07.pdf page=229
   Starting offset  -  Adjusted offset  -  Deduction amount
   __________________________________________________________
      *R&D entity's corporate tax rate for the present year
```

where: adjusted offset means the *tax offset the R&D entity would have received under section 355-100 for the offset year if the total amount mentioned in subsection 355-100(1) for that tax offset were reduced by the portion of the clawback amount that is attributable to the offset year.

deduction amount means the portion of the clawback amount that is attributable to the offset year, multiplied by the R&D entity's *corporate tax rate for the offset year. starting offset means the amount of the *tax offset the R&D entity has received, or is entitled to receive, under section 355-100 for the offset year.
