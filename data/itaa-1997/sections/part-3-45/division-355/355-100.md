...
| 2 | at any time during the income year an *exempt entity, or combination of exempt entities, would control the *R&D entity in a way described in section 328-125 (connected entities) if: (a) references in section 328-125 to 40% were references to 50%; and (b) subsection 328-125(6) were ignored | the R&D entity's *corporate tax rate for the income year |
