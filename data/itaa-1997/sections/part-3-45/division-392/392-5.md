...
```ingest-formula source=vol07.pdf page=384
                    Basic taxable income and average income

               Basic taxable income        Average income
...
```ingest-formula source=vol07.pdf page=385
                   Tax offsets and extra income tax with averaging

               Tax liability without averaging        Averaged tax liability

                  9000
                  8000                    Tax
                  7000                    offset
                  6000                                        Tax
Tax liability ($) 5000           Tax                          offset
                  4000           offset
                  3000    Tax
                  2000    offset               Extra          Extra
                  1000                         tax            tax
                     0
                          5      6      7      8      9      10
          Income years since Division first applied to taxpayer's assessment
