...
```ingest-formula source=vol07.pdf page=358
                                Member’s rent
       Total tax offsets       _______________
                                  Total rent
```

where: member’s rent means:
...
```ingest-formula source=vol07.pdf page=359
                                   Amount of the * tax offset to which the
                                indirect entity would otherwise be entitled
       Amount worked out                   under section 380-15
       under subsection (2)     _____________________________________________
                                             Total tax offsets
```
