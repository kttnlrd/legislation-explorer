...
<a id="s28-150-5"></a>
**(5)** For the purposes of the rules about retaining and producing records of expenses (see Subdivision 900-G), the log book is treated as a record of the *car expenses for each year for which you use a _____________________________________

*business use percentage that you are relying on the log book to support.
