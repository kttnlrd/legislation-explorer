...
<a id="s28-100-1"></a>
**(1)** To use this method, you must substantiate the *car expenses under Subdivision 900-C. _____________________________________
...
• how to keep a log book. The log book is relevant to estimating the number of business kilometres the *car travelled in the period when you *held it during the income year.
