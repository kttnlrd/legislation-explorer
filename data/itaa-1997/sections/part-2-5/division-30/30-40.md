...
```ingest-unclassified source=vol01.pdf page=304
Item    Fund, authority or            Special conditions—fund,       Special
        institution                   authority or institution       conditions—
                                                                     gift
3.1.1   a university, college,        the approved research          the gift must
        institute, association or     institute must be:             be made for
        organisation which is an                                     purposes of
        approved research institute   (a) an *Australian             scientific
        for the purposes of               government agency; or      research in the
        section 73A (Expenditure on   (b) a *registered charity; or  field of natural
        scientific research) of the   (c) operated by an Australian  or applied
        _Income Tax Assessment Act        government agency or a     science
        1936_                             registered charity
```
