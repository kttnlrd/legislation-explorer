...
> **Note 3:** For step 5, the replacement entity may choose to use the officially quoted price of the qualifying interests as their market value (see subsection 124-784A(3)). First element of cost base—interests acquired in exchange for replacement interests and cash etc.
...
```ingest-formula source=vol04.pdf page=128
