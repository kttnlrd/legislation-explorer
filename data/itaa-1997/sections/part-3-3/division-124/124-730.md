...
<a id="s124-730-2"></a>
**(2)** However, you work out the *cost base and *reduced cost base of *CGT assets (that you are not taken to have *acquired before

20 September 1985) and that are part of the new entitlement a bit differently where section 124-720 or 124-725 applies.

<a id="s124-730-3"></a>
**(3)** The first element of your *cost base for each of those assets is:

```ingest-formula source=vol04.pdf page=108
                                     Market value of separate asset
CB of post-CGT original entitlement  __________________________________ ×
