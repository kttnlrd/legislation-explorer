...
> <a id="s124-140-1A-a"></a>
> **(a)** you are a foreign resident just before the *CGT event happens (or just before one or more of the CGT events happens); or

> <a id="s124-140-1A-b"></a>
> **(b)** you are the trustee of a trust that is a *foreign trust for CGT purposes for the income year in which the event happens (or for an income year in which one or more of those events happens); there is no roll-over under this section unless the conditions in subsection (1B) are satisfied.
