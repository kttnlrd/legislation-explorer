...
<a id="s126-15-1"></a>
**(1)** There are the roll-over consequences in section 126-5 if the trigger event involves a company (the transferor) or a trustee (also the

transferor) and a *spouse or former spouse (the transferee) of another individual because of:
...
relation to those matters, unless the agreement is varied or set aside.
...
> <a id="s126-15-2-c"></a>
> **(c)** a *CGT event happens in relation to it. Relevant CGT assets
