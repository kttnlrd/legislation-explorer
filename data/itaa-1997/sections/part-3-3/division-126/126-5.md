...
<a id="s126-5-8"></a>
**(8)** For a creation case, the _first_ element of the asset’s *cost base (in the hands of the transferee) is the amount applicable under this table. The first element of its *reduced cost base is worked out similarly.
