...
```ingest-unclassified source=vol04.pdf page=239
Item   In this situation:           The modification is...
3      You *acquire units in a      The first element of the *cost
       unit trust by converting a   base of the units is the sum of:
       *convertible interest        (a) the cost base of the convertible
       (except one that is a            interest at the time of
       *traditional security) that      conversion; and
       was issued by the trustee    (b) any amount paid to convert the
       of the unit trust after          convertible interest, except to
       28 January 1988.                 the extent that the amount is
                                        represented in the paragraph (a)
                                        amount; and
