...
```ingest-unclassified source=vol04.pdf page=233
Item  In this situation:   You are taken to have    There is this effect:
                           *acquired the bonus
                           equities when:

4     You *acquire the     You *acquired the        Any *capital gain or
      original equities    original equities        *capital loss you make
      before                                        from the bonus equities
