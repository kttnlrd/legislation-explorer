...
<a id="s130-40-6"></a>
**(6)** The rights to *acquire units or to acquire an option to acquire units in a unit trust must have been issued by the trustee after 28 January 1988. Modifications on exercise of rights
...
```ingest-unclassified source=vol04.pdf page=236
Item   In this situation:        The modification is...

3      You exercise rights       The first element of your *cost base
       issued to you to *acquire for the shares, units or options is the
       the *shares, units or     sum of:
       options, and you
       acquired the original     (a) the *market value of the rights
       shares or *convertible        when they were exercised; and
       interests, or the original
       units or convertible      (b) any amount paid to exercise the
       interests, before             rights, except to the extent that
       20 September 1985.            the amount is represented in the
                                     paragraph (a) amount; and

                                 (c) all the amounts to be added
                                     under subsection (6A).
