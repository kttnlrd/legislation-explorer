...
```ingest-formula source=vol04.pdf page=249
   The *corporate tax rate            The amount paid up
 for the minerals explorer          by the investor on the
    for the income year                share during the
    in which the *share               investment period
         is issued
```
