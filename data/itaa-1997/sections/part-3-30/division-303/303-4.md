...
division: "303"
division_title: "Superannuation benefits paid in special circumstances"
subdivision: "303-A"
...
```ingest-formula source=vol06.pdf page=333
...
> <a id="s303-4-2-b"></a>
> **(b)** would apart from this Subdivision apply to you in respect of an amount of defined benefit income; your defined benefit income cap for the financial year is the following amount (rounded up to the nearest dollar):

```ingest-formula source=vol06.pdf page=333
 The *general transfer balance                Number of days remaining in the
   cap for the *financial year        1  +      *financial year after that day
                                  ´
