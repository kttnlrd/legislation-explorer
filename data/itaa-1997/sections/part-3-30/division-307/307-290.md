...
```ingest-formula source=vol06.pdf page=387
           Amount of                            Service days
   *superannuation lump sum      ´     _______________________________________
                                        Service days  +  Days to retirement
```

where: days to retirement is the number of days from the day on which the deceased died to the deceased’s *last retirement day. service days is the number of days in the *service period for the lump sum.
