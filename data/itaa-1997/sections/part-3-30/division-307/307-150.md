...
```ingest-formula source=vol06.pdf page=375
                                    Number of days in the *service period
                                           for the lump sum that
 Original tax free component              occurred before 1 July 1983
                                ×
     and untaxed element            Number of days in the *service period
                                              for the lump sum
```
