...
```ingest-formula source=vol06.pdf page=384
                              Value of your supported super interests
   Outstanding balance   ×
                              Value of all supported super interests
```

where: outstanding balance means the outstanding balance on the *borrowing at the time of working out your *total superannuation balance. value of all supported super interests means the sum of the *values at that time of all *superannuation interests in the *regulated superannuation fund that are supported by the asset or assets that secure the *borrowing.
