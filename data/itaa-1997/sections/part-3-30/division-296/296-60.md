...
```ingest-formula source=vol06.pdf page=294
Relevant                            Net exempt            The entity’s
taxable         Assessable          current               *non-arm’s               Pooled
income or       contributions    +  pension               length component      +  superannuation
loss                                income                for the year (if any)    trust
                                                                                   component
```
...
```ingest-formula source=vol06.pdf page=295
                                        æ                          ö
                                        ç   Entity’s average units ÷
*Division 296 fund earnings for     ´   ç                          ÷
the trust for the relevant year         ç    Total average units   ÷
                                        è                          ø
```
...
> **Note 3:** The provisions mentioned in paragraph (c) of this subsection still apply for the purposes of working out the entity’s net exempt current pension income under subsection (1) of this section. Pooled superannuation trusts
...
```ingest-formula source=vol06.pdf page=296
...
```ingest-formula source=vol06.pdf page=298
The RSA provider’s *RSA        Assessable          Relevant
