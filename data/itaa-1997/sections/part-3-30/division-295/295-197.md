...
<a id="s295-197-2"></a>
**(2)** The benefit is not so included, to the extent that the relevant contribution has been reduced by a notice under section 290-180, if the notice is received by the successor provider before the successor provider has lodged its *income tax return for the income year in which the benefit was transferred. Variation notice received after return lodged
