...
```ingest-formula source=vol06.pdf page=267
                                          Future service days
Benefit amount ×                          ______________________________
                                          Total service days
```
...
> **(b)** for a benefit referred to in paragraph 295-460(c)—the member became unable to engage in *gainful employment; and ending on the member's *last retirement day.
