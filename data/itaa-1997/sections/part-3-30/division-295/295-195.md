...
<a id="s295-195-2"></a>
**(2)** A contribution is not included in the assessable income of a *complying superannuation fund or *RSA provider under item 1 of

the table in subsection 295-190(1) for the income year in which the contribution was made to the extent that it has been reduced by a notice under section 290-180 if:
