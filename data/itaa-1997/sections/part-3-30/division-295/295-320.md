...
```ingest-unclassified source=vol06.pdf page=252
Item  Assessable income      Includes:                 For the income
      of this entity:                                  year:
1     PST                    Amount transferred to it  Of the PST that
                             by a CSF or CADF          includes the last day
                             under section 295-260     of the transferor's
                                                       income year to
                                                       which the agreement
                                                       relates
```
