...
```ingest-unclassified source=vol06.pdf page=241
Item  Assessable income of this entity:   Includes:

1     CSF                                 A contribution:
      *RSA provider
...
| Item | Assessable income of this entity: | Includes: |
| --- | --- | --- |
| 2 | CSF CADF N-CADF *RSA provider | A *roll-over superannuation benefit that an individual is taken to receive under section 307-15 to the extent that: (a) it consists of an *element untaxed in the fund (other than an element untaxed in the fund under subsection 307-290(4)); and (b) is not an *excess untaxed roll-over amount for that individual |
...
<a id="s295-190-2A"></a>
**(2A)** of the Superannuation (Unclaimed Money and Lost Members) Act 1999. Income years in which amounts are included in assessable income
