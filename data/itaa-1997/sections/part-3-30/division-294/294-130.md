...
> <a id="s294-130-1-b"></a>
> **(b)** if it is covered by any of items 2 to 7 of that table—it is in the *retirement phase just before 1 July 2017. Capped defined benefit income streams
...
```ingest-unclassified source=vol06.pdf page=210
4      Life expectancy       it is an annuity for the purposes of the SIS Act that is
       annuity               provided under a contract that meets the standards of
```

Capped defined benefit income streams

```ingest-unclassified source=vol06.pdf page=211
