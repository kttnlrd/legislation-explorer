...
subdivision: "320-B"
subdivision_title: "What is included in a life insurance company’s assessable income"
section: "320-37"
...
> <a id="s320-37-1-iv"></a>
> **(iv)** amounts derived on or after 1 January 2003 that are attributable to income bonds, funeral policies or

*sickness policies, that were issued before 1 January 2003; and
...
```ingest-formula source=vol07.pdf page=80
...
where: all foreign establishment policy liabilities means the average value for the income year (as calculated by an *actuary) of the policy liabilities (as defined in the *Valuation Standard) for all *life insurance policies that:
