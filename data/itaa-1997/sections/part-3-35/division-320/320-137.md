...
subdivision: "320-D"
subdivision_title: "Income tax, taxable income and tax loss of life insurance companies"
section: "320-137"
...
```ingest-formula source=vol07.pdf page=97
   ...
   Total amount credited to the *RSA   *annuity covered by subsection (3A) was paid
        during the income year
                                      Number of days in the income year
                                          in which t he RSA existed
```

<a id="s320-137-3A"></a>
**(3A)** An *annuity is covered by this subsection if it is a *superannuation income stream that is in the *retirement phase. Relevant deductions
...
> <a id="s320-137-4-b"></a>
> **(b)** amounts that the company can deduct (other than any *tax losses) in respect of the investment of the company's *complying superannuation assets in relation to the period

during which those assets were complying superannuation assets;
