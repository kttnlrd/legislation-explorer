...
```ingest-formula source=vol07.pdf page=130
                         Continuous disability policy days
Section 320-30 amount    ________________________________
                                     365
```

where: continuous disability policy days means the number of days during the income year in which the transfer took place that the originating company held *continuous disability policies.
