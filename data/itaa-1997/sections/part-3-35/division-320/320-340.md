...
<a id="s320-340-3"></a>
**(3)** The amount worked out using this formula is included in the assessable income of the originating company for the income year in which the transfer took place: Continuous disability policy days Section 320-30 amount where: continuous disability policy days means the number of days during the income year in which the transfer took place that the originating company held *continuous disability policies.
