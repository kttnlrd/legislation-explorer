...
```ingest-unclassified source=vol07.pdf page=118
Annuity conditions

Item   Column 1                                 Column 2
       The condition in column 2 applies         The condition is that ...
       in the following circumstances ...

1      there is a residual capital value         the contract under which the annuity
       (within the meaning of section 27H        is payable does not permit the
       of the Income Tax Assessment Act          residual capital value to exceed the
       1936) in relation to the *immediate        annuity's purchase price (within the
       annuity.                                  meaning of that section).
```
...
```ingest-unclassified source=vol07.pdf page=120
Annuity conditions
...
4      all circumstances.                        there is no unreasonable deferral of
