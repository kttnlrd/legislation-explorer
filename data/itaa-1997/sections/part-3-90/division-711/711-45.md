...
```ingest-formula source=vol08.pdf page=264
Deduction *Corporate tax rate - Double-counting adjustment
```

where: double-counting adjustment means the amount of any reduction that has already occurred in the accounting liability under subsection (1) to take account of the future availability of the deduction.
...
<a id="s711-45-6A"></a>
**(6A)** If any *share in the leaving entity needed to be disregarded under section 703-37 in order for the leaving entity to be a *wholly-owned subsidiary of the *head company at the leaving time, the step 4 amount is increased by the sum of the *market values of those shares. Increase for non-share capital account balance
