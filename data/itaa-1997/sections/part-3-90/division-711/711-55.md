...
> <a id="s711-55-3-b"></a>
> **(b)** by working out the tax cost setting amount for membership interests in entities that are held by other entities before

working out the tax cost setting amount for membership interests in those other entities. Tax cost setting amount for membership interests acquired by head company
