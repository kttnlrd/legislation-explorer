...
> <a id="s709-215-3-b"></a>
> **(b)** the period ends at the time          (a) the start of the (the write-off time) the                 income year in claimant actually writes off             which the debt or part of the debt             write-off time occurs;
