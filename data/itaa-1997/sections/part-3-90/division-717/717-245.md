...
```ingest-formula source=vol08.pdf page=431
    Leaving company's attribution account            Attribution surplus
    percentage in relation to the attribution         for the attribution
       account entity at the leaving time             account entity in

      *Head company's attribution account        relation to the head
    percentage in relation to the attribution     company just before
    account enti ty just before the leaving time      the leaving time
```
