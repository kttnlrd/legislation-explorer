...
> **Note 1:** That section is relevant if the joining entity has been a non-fixed trust at any time in the period from the start of the income year in which the

entity made the loss until the time it became a subsidiary member of the joined group (and was not an excepted trust at all times in the period).
