...
subdivision: "716-A"
subdivision_title: "Assessable income and deductions spread over several membership or non-membership periods"
section: "716-25"
...
• the number of days that are in both the income year and the *spreading period, and on which the entity was a *subsidiary member of the group; divided by:

• the number of days that are in both the income year and the spreading period. Entity’s deduction for a non-membership period
...
• the number of days that are in both the non-membership period and the *spreading period; divided by:

• the number of days that are in both the income year and the spreading period. Spreading period
...
> **Note:** For example, under section 82KZMD of the Income Tax Assessment Act 1936 an item of expenditure on something is spread over the period over which that thing is to be provided, which is called the eligible service period. Deductions for the item for a sequence of

income years are worked out by reference to how much of that period falls within each of those income years.
