...
> **Note 2:** This subsection affects the percentages and amounts to be taken into account for working out under section 40-440 the decline in value of assets in the pool and the closing pool balance. Allocating other low-cost assets to head company’s low-value pool
...
```ingest-unclassified source=vol08.pdf page=408
   If the joining       Sections 705-40 and 705-57 operate as if the joining
   time is:             entity’s terminating value for the hypothetical asset were:
1  In the first day of  The *closing pool balance for the joining entity’s low-value
   an income year of    pool for the previous income year
   the joining entity
2  In another day       The *closing pool balance for the joining entity’s low-value
                        pool for the non-membership period described in
