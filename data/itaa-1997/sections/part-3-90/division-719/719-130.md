...
> **Note:** An example of the effect of this subsection is that section 701-40 (Exit history rule) does not apply. See instead section 719-125. (cost setting on exit) does not apply.
