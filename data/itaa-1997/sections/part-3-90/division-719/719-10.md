...
| The entity must be a | The entity must: | The entity must be: |
| company, trust or | (a) be an Australian | (a) a *wholly-owned |
| partnership and, if it is | resident (but not a | subsidiary of any of |
| a company, all or some | *prescribed dual | those *eligible tier-1 |
| of its taxable income (if | resident), if it is a | companies; or |
| any) must have been | company; or | (b) an entity that would be |
| taxable at a rate that is | (b) meet the conditions in | covered by |
| or equals the *corporate | item 1, 2 or 3 of the | paragraph (a), if it were |
| tax rate apart from this | table in section 703-25, | assumed that all of the |
| Part | if it is a trust; or | membership interests |
| The entity must not be | (c) be a partnership | that are beneficially |
| covered by an item in |  | owned by any of those |
| the table in |  | eligible tier-1 companies |
| section 703-20 |  | were owned by a single one of those eligible |
| The entity must not be |  | tier-1 companies |
