...
```ingest-unclassified source=vol08.pdf page=475
...
```ingest-unclassified source=vol08.pdf page=476
Column 1                 Column 2                    Column 3
If the test company      Apply this section again    Take account only of
for the focal company    as if this company were     things that happened
is identified:           the focal company:          before this event:
...
2 Under subsection (6) as   The first head company      The first head company
  ...
  first head company                                    group mentioned in
                                                        subsection (6)
```
...
| Column 1 If: | Column 2 The test company for the focal company is: |
| --- | --- |
