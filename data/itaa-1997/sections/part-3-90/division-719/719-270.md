...
```ingest-unclassified source=vol08.pdf page=479
       If:                                       The relevant time is:
1      The focal company made the loss apart     The start of the income year for
       from Subdivision 707-A                    which the focal company made the
                                                 loss
2      The focal company made the loss           The time of the transfer
       because it was transferred to the focal
       company under Subdivision 707-A
```
...
```ingest-unclassified source=vol08.pdf page=480
       If:                                            The relevant time is:
1      The test company made the loss apart           The start of the income year for
       from Subdivision 707-A (even if the test       which the test company made the loss
       company later transferred the loss to
       itself in a *COT transfer)
2      The test company made the loss because         The time of the transfer
       it was transferred to the test company
       under Subdivision 707-A in a transfer
       other than a *COT transfer (even if the
       test company first made the loss apart
...
```ingest-unclassified source=vol08.pdf page=481
       If:                                            The relevant time is:
1      The test company made the loss apart           The start of the income year for
       from Subdivision 707-A (even if the test       which the test company made the loss
       company later transferred the loss to
...
2      The test company made the loss because         The time of the transfer
       ...
       test company first made the loss apart
       from that Subdivision)
3      The test company is the test company for       The time that was the relevant time
       the focal company for the loss because         under subsection (1) for the test
       the test company was the *top company          company as the test company for the
       for a *MEC group whose *head company           _first_ company for which the test
       made the loss before it was transferred to     company was the test company for
       the focal company under                        the loss
       Subdivision 707-A
```
