...
> **Note:** That section applies to a company's utilisation for an income year of losses in a bundle if the losses are transferred under Subdivision 707-A after the start of the year or if the value of the available fraction for the bundle changes during the year while the

company is treated as having made the losses because of that Subdivision.
