...
```ingest-formula source=vol08.pdf page=172
            *Market value of first
        entity's *membership interests
              in second entity                  Second entity's profit loss
                                                    adjustment amount
...
```ingest-formula source=vol08.pdf page=173
          *Market value of first entity's
          membership interests in third
        entity held through second entity        Third entity's profit loss
                                                    adjustment amount
        *Market value of all *membership
