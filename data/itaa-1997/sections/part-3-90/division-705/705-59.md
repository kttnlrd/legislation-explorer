...
<a id="s705-59-1"></a>
**(1)** This section applies to each set of *linked assets and liabilities that the joining entity has immediately before the joining time. Tax cost setting amount for assets where entities become subsidiary members of consolidated groups Division 705 Section 705-59
...
| Item | If the asset's | This is the result for the | This is the result for the |
| --- | --- | --- | --- |
| 1 | is less than or equal to the available amount | its *tax cost setting amount is that market value (and the asset is not taken into account under paragraph 705-35(1)(c)) | only the difference (if any) is taken into account under subsection 705-70(1) for the one or more liabilities |
 members of consolidated groups Section 705-59

**Treatment of linked assets and liabilities: single reset cost base asset case**

| Item | If the asset's | This is the result for the | This is the result for the |
| --- | --- | --- | --- |
| 2 | is greater than the available amount | its *tax cost setting amount is: | the one or more liabilities are not taken into |


> <a id="s705-59-3-a-2"></a>
> **(a)** the available amount;           account under plus                           subsection 705-70(1)

> <a id="s705-59-3-b-2"></a>
...
> <a id="s705-59-5-b"></a>
> **(b)** next, work out the consequences under this table. Tax cost setting amount for assets where entities become subsidiary members of consolidated groups Division 705 Section 705-59

**Treatment of linked assets and liabilities: all other cases**

| Item | In this case: | This is the result for the | This is the result for |
| --- | --- | --- | --- |
...
> **Note:** Paragraph 705-35(1)(c) then allocates the reduced allocable cost amount among the joining entity's reset cost base assets. Tax cost setting amount for assets where entities become subsidiary members of consolidated groups Division 705 Section 705-60
