...
acquired deductions means all deductions covered by subsection (2) that are not owned deductions. owned deductions means the sum of all deductions for which the following requirements are satisfied:
