...
<a id="s705-145-3"></a>
**(3)** The tax cost setting amount worked out for assets of an entity mentioned in subsection (2) consisting of *membership interests in another such entity is to be used as the amount for those interests under subsection 705-65(1) (step 1 of allocable cost amount) in working out the tax cost setting amount for assets of that other
 entity.
