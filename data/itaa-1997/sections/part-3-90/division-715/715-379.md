...
> <a id="s715-379-2-b"></a>
> **(b)** if subparagraph (1)(b)(ii) applies—treat the *head company as starting to have the accounting liability at the leaving time

for receiving a payment equal to the tax cost setting amount of the corresponding asset.
