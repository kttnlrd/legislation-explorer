...
<a id="s715-145-2"></a>
**(2)** The asset’s adjustable value at the time (the test time) just before the leaving time is worked out under this table. (If the asset is covered by 2 or more items, there are consequences for it under the choice provisions and this section in respect of each of the items.) Adjustable value at the test time
