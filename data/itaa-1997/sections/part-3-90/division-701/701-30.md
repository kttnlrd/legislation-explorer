...
• section 716-850 (about grossing up threshold amounts for periods of less than 365 days). Subdivision 716 also affects the tax position of the head company of a group of which the entity has been a subsidiary member for some but not all of the income year.
...
for the current income year only if it has such an excess for the non-membership period (if any) ending at the end of the current income year. The amount of the excess for the current income year is the amount of the excess for the non-membership period.
