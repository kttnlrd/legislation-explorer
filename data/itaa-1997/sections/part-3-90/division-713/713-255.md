...
<a id="s713-255-2"></a>
**(2)** Do not work out *tax cost setting amounts for *membership interests in the partnership. Partnership is only entity that exits—tax cost setting amount for partnership cost setting interests
