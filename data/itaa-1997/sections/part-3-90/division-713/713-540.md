...
> **Note:** This prevents the loss from being transferred to the head company of the consolidated group under Subdivision 707-A (because it means the

life insurance subsidiary could not have utilised the loss for the trial year). As a result, section 707-150 prevents any other entity from utilising the loss for an income year ending after the joining time. Imputation rules for life insurance companies joining consolidated group
