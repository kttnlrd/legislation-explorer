...
<a id="s713-515-3"></a>
**(3)** If the *retained cost base asset is covered by paragraph (1)(c), its *tax cost setting amount is the embedded value (see subsection 121AM(1) of the Income Tax Assessment Act 1936) on

the applicable accounting day (see subsection 121AM(3) of that Act) of the *life insurance company concerned reduced by the net value of shareholders’ assets held by the company on that day.
