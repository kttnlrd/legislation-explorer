...
**(5)** Where a resident of one the Contracting States derives income which, in accordance with the provisions of this Agreement shall be taxable only in the other Contracting State, the firstmentioned State may take that income into account in calculating the amount of its tax payable on the remaining income of that resident.
