...
- **(a)** in the case of Australia: the income tax, and the resource rent tax in respect of offshore projects relating to exploration for or exploitation of petroleum resources, imposed under the federal law of the Commonwealth of Australia;

- **(b)** in the case of Spain:

- **(i)** the Income Tax on Individuals ( el Impuesto sobre la renta de las Personas Fisicas ); and (ii) the Corporation Tax ( el Impuesto sobre sociedades ).
