...
- **(k)** the term & ldquo;tax "means Australian tax or Argentine tax, as the context requires, but does not include any penalty or interest imposed under the law of either Contracting State relating to its tax. As regards the application of this Agreement by a Contracting State at any time, any term not defined in this Agreement shall, unless the context otherwise requires, have the meaning which it has at that time under the law of that State concerning the taxes to which this Agreement applies.
