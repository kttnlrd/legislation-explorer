...
- **(l)** the term "tax" means Australian tax or South African tax as the context requires, but does not include any penalty or interest imposed under the law of either Contracting State relating to its tax. As regards the application of the Agreement at any time by a Contracting State, any term not defined in the Agreement shall, unless the context otherwise requires, have the meaning which it has at that time under the law of that State concerning the taxes to which the Agreement applies, any meaning under the applicable law of that State prevailing over a meaning given to the term under other law of that State.
