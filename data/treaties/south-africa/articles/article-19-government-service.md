...
2
(a)
Any pension paid by, or out of the funds created by, a Contracting State, or a political subdivision or a local authority of that State, to an individual in respect of services rendered in the discharge of governmental functions shall be taxable only in that State.
(b)
However, that pension shall be taxable only in the other Contracting State if the individual:
(i)
is a resident of, and a citizen or a national of that State; and
(ii)
the services in respect of which that pension is paid were rendered in that State.
3
