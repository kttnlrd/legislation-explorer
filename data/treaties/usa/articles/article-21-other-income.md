...
**(2)** The provisions of paragraph (1) shall not apply to income, other than income from real property as defined in paragraph (2) of Article (Income from Real Property), derived by a resident of one of the Contracting States where that income is effectively connected with a permanent establishment or fixed base situated in the other Contracting State. In that case the provisions of Article (Business Profits) or Article (Independent Personal Services), as the case may be, shall apply.
