...
**(2)** In this Agreement, the terms "Australian tax" and "Fiji tax" do not include any penalty or interest imposed under the law of either Contracting State relating to the taxes to which this Agreement applies by virtue of Article 2.

**(3)** In the application of the provisions of this Agreement by a Contracting State, any term not defined in this Agreement shall, unless the context otherwise requires, have the meaning which it has under the laws of that State from time to time in force relating to the taxes to which this Agreement applies by virtue of Article 2.
