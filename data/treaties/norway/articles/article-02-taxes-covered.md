...
- **(i)** the income tax; and (ii) the resource rent tax in respect of offshore projects relating to exploration for or exploitation of petroleum resources, imposed under the federal law of Australia;

- **(b)** in the case of Norway:

- **(i)** the tax on general income; (ii) the tax on personal income; (iii) the special tax on petroleum income; (iv) the resource rent tax on income from production of hydro-electric power;

- **(v)** the withholding tax on dividends; and (vi) the tax on remuneration to non-resident artistes, etc.
