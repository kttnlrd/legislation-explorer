...
> <a id="s153-55-2-b"></a>
> **(b)**  to have a *value equal to 10/11 of the amount that is payable to the principal by the intermediary in respect of the intermediary’s supply. The intermediary is taken to make a corresponding *creditable acquisition from the principal.
...
<a id="s153-55-4"></a>
**(4)**  However, this section no longer applies, and is taken never to have applied, if the principal issues to the third party, in the principal’s own name, any *tax invoice or *adjustment note relating to the supply. (4A) Without limiting subsection (4), this section does not apply in relation to a supply to which section 84-55 or section 84-81 applies.
