...
|  | Net assets + | Tainted | – Solvency |
| --- | --- | --- | --- |
| Adjusted passive ´ | outsta | nding claims | amount |
| income | Tot | al assets |  |
...
<a id="s446-5"></a>
**(5)**  In subsection (4): solvency amount is the amount worked out using the formula:
