...
<a id="s260-75-6"></a>
**(6)** After receiving the Commissioner's notice, the receiver must set aside, out of the assets available for paying amounts covered by paragraph (5)(a) or (b) (the ordinary debts), assets with a value calculated using the following formula: æ                            ö

|  | ç | Notified | ÷ |
| --- | --- | --- | --- |
| Total value of assets | ç | amount | ÷ |
| ´ | ç |  |  |
| available to pay ordinary debts | ç Notified ç amount è | Amount of ÷ + remaining ÷ ordinary debts | ÷ ø |
| where: |  |  |  |
